 ...
 * application should use the {@link AsyncQueryHandler} or
 * {@link AsyncTask} object to perform operations asynchronously on a separate thread.
 */
public class NotesList extends ListActivity {
    ...
    private static final String[] GROUPSPRO = new String[]{
    ...
    private static final String selection = NotePad.Notes.COLUMN_NAME_GROUPID + " =? ";
    /**
...
//END_INCLUDE(copy)
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (Intent.ACTION_PICK.equals(action) || Intent.ACTION_GET_CONTENT.equals(action)) {
            ...
            intent.putExtra("gourpid", groupid);
            startActivity(intent);
        }
    }

    private void addGroup() {
        final LinearLayout editForm = (LinearLayout) getLayoutInflater().inflate(R.layout.edit_dialog, null);
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        EditText editText = (EditText) editForm.findViewById(R.id.edit_group);
                        // Toast.makeText(NotesList.this,editText.getText().toString(),Toast.LENGTH_SHORT).show();
                        //把分类信息添加到数据库
                        ContentValues contentValues = new ContentValues();
                        contentValues.put(NotePad.NotesGroup.COLUMN_NAME_GROUPTITLE, editText.getText().toString());
                        getContentResolver().insert(NotePad.NotesGroup.CONTENT_URI, contentValues);
                        createGrouplist();
                    }
                })
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("NotesList Page") // TODO: Define a title for the content shown.
...
/*    private void backgroud(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(NotesList.this);
        final String[] colors = {"yellow","white","black"};
