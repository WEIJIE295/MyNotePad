...
public class NoteEditor extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((intent.getStringExtra("gourpid"))!=null) {
            groupid = Integer.parseInt(intent.getStringExtra("gourpid"));
        }
        ...
        if (mCursor.moveToNext()){
            String gid  = mCursor.getString(mCursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_GROUPID));
            if (gid!=null)
...
//END_INCLUDE(paste)
    ...
    private final void updateNote(String text, String title) {
        ...
        values.put(NotePad.Notes.COLUMN_NAME_GROUPID,groupid);
